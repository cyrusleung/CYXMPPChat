...
-(void)cacheImage:(NSDictionary*)aDic
{
    ...
    //拉伸到多大
    newRect.size.width=296;
    newRect.size.height=216;
...
-(void)cacheImage2:(NSDictionary*)aDic
{
    NSURL *aURL=[aDic objectForKey:@"url"];
...
-(void)cacheImage3:(NSDictionary*)aDic
{
    NSURL *aURL=[aDic objectForKey:@"url"];
...
-(void)cacheImage4:(NSDictionary*)aDic
{
    NSURL *aURL=[aDic objectForKey:@"url"];
...
//原始比例不压缩
-(void)cacheImageOriginal:(NSDictionary*)aDic
{
    NSURL *aURL=[aDic objectForKey:@"url"];
