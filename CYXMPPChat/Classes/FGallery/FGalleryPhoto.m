...
- (id)initWithThumbnailImage:(UIImage *)image thumb:(NSString*)thumb fullsizePath:(NSString*)fullsize delegate:(NSObject<FGalleryPhotoDelegate>*)delegate
{
    self = [super init];
	_thumbnail=image;
    _fullsize=image;
