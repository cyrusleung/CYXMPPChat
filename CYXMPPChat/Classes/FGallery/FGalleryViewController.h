...
typedef enum
{
    ...
    FGalleryPhotoSourceTypeLocalImage
} FGalleryPhotoSourceType;

@protocol FGalleryViewControllerDelegate;

@interface FGalleryViewController : UIViewController <UIScrollViewDelegate,FGalleryPhotoDelegate,FGalleryPhotoViewDelegate,MBProgressHUDDelegate> {
    ...
    UIButton *backButton;
    UILabel *pagesLabel_custom;
    UILabel *imgTextLabel;
    UIButton *imgSaveButton;
    UIButton *imgShareButton;
}
